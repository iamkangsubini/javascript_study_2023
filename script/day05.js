...
console.log(`d=${d}, ${typeof(d)}`); //d=2, string
//Number메서드는 객체없이 사용가능하다. 그래서 다른 메서드를 괄호안에 넣어 사용할 수 있다.
//예) Number(객체.메서드())
console.log('-----------------------------');
...
console.log(`userInput value=${typeof(userInput.value)}`); //userInput value=
...
/* resultBtn.addEventListener('click',function(){
    ...
    console.log(userInputNumber+1) //16 
}); */
console.log('-----------------------------');
//구구단 과제 풀이
