...
let f = 10
let g = 20
if(d===true){console.log('실행1')} //실행1 > d는 true와 데이터타입까지 같다
if(f>10){console.log('실행2')} // x > f는 10보다 크다
if(g<=20){console.log('실행3')} //실행3 > g는 20보다 작거나 같다.
if(e!==true){console.log('실행4')} //실행4 > e는 true와 데이터타입까지 다르다
//------------------------------
console.log('----------------------')
//관리자만 접속할 수 있는 페이지
...
//사용자의 나이를 입력받고 10살 이하라면 '놀이기구 탐승불가'
